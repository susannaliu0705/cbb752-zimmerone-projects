...
<div class="ritz grid-container" dir="ltr">
    <table class="waffle" cellspacing="0" cellpadding="0">
        <thead>
            <tr>
                <th style="width:70px;" class="row-header freezebar-origin-ltr"></th>
                <th id="154769403C0" style="width:38px;" class="column-headers-background">A</th>
                <th id="154769403C1" style="width:38px;" class="column-headers-background">B</th>
                <th id="154769403C2" style="width:55px;" class="column-headers-background">C</th>
                <th id="154769403C3" style="width:520px;" class="column-headers-background">D</th>
                <th id="154769403C4" style="width:38px;" class="column-headers-background">E</th>
                <th id="154769403C5" style="width:38px;" class="column-headers-background">F</th>
                <th id="154769403C6" style="width:38px;" class="column-headers-background">G</th>
                <th id="154769403C7" style="width:38px;" class="column-headers-background">H</th></tr>
        </thead>
        <tbody>
